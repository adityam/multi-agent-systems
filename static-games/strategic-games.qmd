...
A strategy $s_i \in \ALPHABET S_i$ is called (strongly or weakly) __dominant strategy__ if it (strongly or weakly) dominates all other strategies $b_i \in \ALPHABET S_i \setminus \{s_i\}$.
