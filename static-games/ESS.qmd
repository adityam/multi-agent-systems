...
b. Consider the symmetric game in @exr-NE-more-than-2, which is repeated below for convenience.
...
::: {#exr-evolution-example}

Consider the symmetric game of @exr-negative-definite. Run replicator dynamics and BNN dynamics on this game and describe the behavior (converges and if so to what value, does not converge and oscillates, etc.). 
