...
b. Let $σ_1 = (p_0, p_1, p_2)$ and $σ_2 = (q_0, q_1, q_2)$ be mixed strategies that are completely mixed, i.e., $p_i, q_i > 0$, $i \in \{0,1,2\}$. By the irrelevance principle, for player 1 we must have
$$
