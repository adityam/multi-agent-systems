...
We now revist the notion of mixed strategies in finite games. Recall that given a finite game $\mathscr{G} = \lange N, (\ALPHABET S_i)_{i \in N}, (u_i)_{i \in N} \rangle$ and mixed strategies $σ = (σ_i)_{i \in N}$ for the players, the expected utility is defined as
